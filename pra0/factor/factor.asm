...
START PROC 
    ...
    MOV AL, DATO_1 		;GUARDAMOS FDATO1 EN AL PARA LA MULTIPLICACIÓN
    MUL	DATO_2			;AX=AL*DATO_2
	MOV CX, AX			;ENTRADA DE LA RUTINA ES CX, COPIAMOS EL RESULTADO DE LA MULTIPLICACIÓN
    CALL FACTOR                      
